...
namespace PVS.MediaPlayer
{
    ...
    /// <summary>
    /// Specifies the audio format recorded with the recorder.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the video format recorded with the recorder.
    /// </summary>
    public enum RecorderVideoFormat
    {
        /// <summary>
        /// H.264 video.
        /// </summary>
    ...
    {
        #region Fields (PeakLevelEventArgs)
    ...
    {
        #region Fields (SystemAudioDevicesEventArgs)
