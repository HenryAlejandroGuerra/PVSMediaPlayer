...
{
	public partial class DeviceInputVolumeDialog : Form
	{
        #region Fields
        ...
        public DeviceInputVolumeDialog(Player basePlayer)
		{
			InitializeComponent();
		...
		private void MasterVolumeDialog_Shown(object sender, EventArgs e)
        {
            ...
            _basePlayer.Events.MediaAudioInputDeviceChanged += BasePlayer_MediaAudioDeviceChanged;
