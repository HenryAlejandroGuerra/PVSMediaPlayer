...
namespace PVSPlayerExample
{
    public partial class WebSiteDialog : Form
    {
        ...
        private const int   AUTO_CLOSE_SECONDS = 45;
        ...
        private void WebSiteDialog_Shown(object sender, EventArgs e)
        {
            if (MainWindow.Prefs.ShowMiniPlayers)
            {
                ...
                _baseForm.myPlayer.DisplayClones.AddRange(_miniDisplays);
        ...
        private void WebSiteDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                _baseForm.myPlayer.DisplayClones.RemoveRange(_miniDisplays);
                _miniDisplays = null;
            }
        }
        ...
        // Radio button clicked - reset close timer
