...
namespace PVSPlayerExample
{
    ...
    internal class DropDownButton : CheckBox
    {
        ...
        /// </summary>
        [Category("Apariencia"), Description("Indica cuando la flecha debe de mostrarse en el menú desplegable."), DefaultValue(true)]
        ...
        /// </summary>
        [Category("Data"), Description("Indica cual es el menú desplegable que aparece al dar click."), DefaultValue(null)]
    ...
    internal class LightPanel : Panel
    {
        ...
        /// </summary>
        [Category("Apariencia"), Description("Indica cuando la luz está encendida"), DefaultValue(false)]
        public bool LightOn
        {
    ...
    internal sealed class CustomButton : Button
    {
        ...
        /// </summary>
        [Category("Apariencia"), Description("Indica cuando el borde está activado."), DefaultValue(false)]
        ...
        /// Gets or sets the control's border color.
        /// </summary>
        [Category("Apariencia"), Description("Borde de color del control.")]
        public Color BorderColor
        {
            get { return _borderPen.Color; }
            set { _borderPen.Color = value; }
    ...
    #region Custom Control : VideoPanel

    internal sealed class VideoPanel : Control
    {
        private SolidBrush brush;
        internal bool Wipe = true;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            if (Wipe) e.Graphics.FillRectangle(brush, ClientRectangle);
        }
