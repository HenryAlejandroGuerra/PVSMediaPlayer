...
{
    public sealed partial class TilesOverlay : OverlayForm, IOverlay
    {
        /*
        ...
        */
        ...
        void TimerTick(object sender, EventArgs e)
        {
            ...
            _sourceHdc = sourceGraphics.GetHdc();
            ...
            if (_puzzleOn)
            {
                ...
                destinationGraphics = CreateGraphics();
                _destinationHdc = destinationGraphics.GetHdc();
                        ...
                        for (int j = 0; j < _horizontalTiles; j++)
                        {
                            ...
                            else
                            {
                                if (_gridOn || (_indicatorsOn && _puzzleArray[index] == index))
                                {
                                    ...
                                    destinationGraphics.ReleaseHdc(_destinationHdc);
                                    if (_indicatorsOn && _puzzleArray[index] == index) destinationGraphics.DrawRectangle(_indicatorPen, _gridRect);
                                    else destinationGraphics.DrawRectangle(_gridPen, _gridRect);
                                    _destinationHdc = destinationGraphics.GetHdc();
                                }
                                else
                                {
                ...
                destinationGraphics.ReleaseHdc(_destinationHdc);
                if (_selectionOn) destinationGraphics.DrawRectangle(_selectPen, _selectRect);
                destinationGraphics.Dispose();

                sourceGraphics.ReleaseHdc(_sourceHdc);
