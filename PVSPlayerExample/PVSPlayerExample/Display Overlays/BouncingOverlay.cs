...
{
    public sealed partial class BouncingOverlay : OverlayForm, IOverlay
    {
        /*
        ...
        */
        ...
        private void MoveBall()
        {
            ...
            {
                if (_ballRect.X + _ballRect.Width <= _playfieldRect.Left - 3)  // ball passed paddle
                {
            ...
            {
                if (_ballRect.X >= _playfieldRect.Right + 3) // ball passed paddle
                {
