...
{
    public sealed partial class PIPOverlay : OverlayForm, IOverlay
    {
        /*
        ...
        */
        ...
        private void PIPOverlay_VisibleChanged(object sender, EventArgs e)
        {
            if (Visible)
            {
                ...
                _pipPlayer1.Sliders.Position.LiveUpdate = _baseForm.myPlayer.Sliders.Position.LiveUpdate;
                MouseDown += _baseForm.myPlayer.Display.Drag_MouseDown;
            }
            else
            {
        ...
        private void SwitchScreensMenuItem_Click(object sender, EventArgs e)
        {
            ...
            // TODO check if playing chapter files

            // base player
            string movie1       = _baseForm.myPlayer.Media.GetName(MediaName.FullPath);
            WebcamDevice webcam1 = _baseForm.myPlayer.Webcam.Device;
            WebcamFormat format1 = _baseForm.myPlayer.Webcam.Format;
            TimeSpan position1  = _baseForm.myPlayer.Position.FromStart;
            TimeSpan startTime1 = _baseForm.myPlayer.Media.StartTime;
            TimeSpan stopTime1  = _baseForm.myPlayer.Media.StopTime;
            bool playing1       = _baseForm.myPlayer.Playing;
            bool paused1        = _baseForm.myPlayer.Paused;
            ...
            bool holdCopy = _baseForm.myPlayer.Overlay.Hold;
            _baseForm.myPlayer.Overlay.Hold = true;
            _baseForm.StopAndPlay = true;

            if (playing2)
            {
                _baseForm.myPlayer.Paused = paused2;
                if (webcam2 != null)
                {
                    _baseForm.myPlayer.Play(webcam2, format2);
                }
                else
                {
                    _baseForm.myPlayer.Play(movie2, position2, stopTime2);
                    _baseForm.myPlayer.Media.StartTime = startTime2;
                }
                _baseForm.Text = _basePlayer.Media.GetName(MediaName.FileNameWithoutExtension);
            }
            ...
            _baseForm.myPlayer.Overlay.Hold = holdCopy;
        }
