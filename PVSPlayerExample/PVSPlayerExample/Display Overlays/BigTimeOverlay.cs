...
namespace PVSPlayerExample
{
    public sealed partial class BigTimeOverlay : OverlayForm, IOverlay
    {
        ...
        */
        ...
        protected override void OnDragEnter(DragEventArgs e) { _baseWindow.DoOnDragEnter(e); }
        protected override void OnDragOver(DragEventArgs e) { _baseWindow.DoOnDragOver(e); }
        protected override void OnDragLeave(EventArgs e) { _baseWindow.DoOnDragLeave(); }
        protected override void OnDragDrop(DragEventArgs e) { _baseWindow.DoOnDragDrop(e); }

		//protected override void OnPaintBackground(PaintEventArgs e)
		//{
		//	base.OnPaintBackground(e);
		//	System.Drawing.Drawing2D.HatchBrush b = new System.Drawing.Drawing2D.HatchBrush(System.Drawing.Drawing2D.HatchStyle.Percent25, Color.Red, BackColor);
        ...
        private void BasePlayer_MediaPositionChanged(object sender, PositionEventArgs e)
        {
            ...
            if (_progressTime)
            {
                startTimerLabel.Text = TimeSpan.FromTicks(e.FromStart).ToString(@"hh\:mm\:ss\.fff");
                endTimerLabel.Text = TimeSpan.FromTicks(e.ToStop).ToString(@"hh\:mm\:ss\.fff");
            }
            else
            {
                startTimerLabel.Text = TimeSpan.FromTicks(e.FromBegin).ToString(@"hh\:mm\:ss\.fff");
                endTimerLabel.Text = TimeSpan.FromTicks(e.ToEnd).ToString(@"hh\:mm\:ss\.fff");
            }
