...
{
    public sealed partial class VideoWall : OverlayForm, IOverlay
    {
        /*
        ...
        */
        ...
        {
            VideoColorDialog colorDialog = new VideoColorDialog(_basePlayer);
            MainWindow.CenterDialog(this, colorDialog);

            if (_display.Visible) colorDialog.Top = _display.Height - colorDialog.Height - 32;
