...
{
    public sealed partial class Mp3CoverOverlay : OverlayForm, IOverlay
    {
        /*
        ...
        */
        ...
        // cover (album art) source - search mp3 before folder
        private void Mp3AndFolderMenuItem_Click(object sender, EventArgs e)
        {
            ...
            folderAndMP3MenuItem.Checked = false;
        ...
        // cover (album art) source - search folder before mp3
        private void FolderAndMP3MenuItem_Click(object sender, EventArgs e)
        {
            _imageSource = ImageSource.FolderOrMedia;
            folderAndMP3MenuItem.Checked = true;
